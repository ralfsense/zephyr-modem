 ...
 * @param script_chats Array of script chats
 * @param script_chats_size Elements in array of script chats
 ...
 *
 * @param user_data Free to use user data passed with modem match callbacks
